...
#SBATCH --job-name=TransDecoder-Lrace    #Set the job name to "JobExample2"
...
## Set Variables ##
transcripts='Lrace_EST_transcriptome_v2.fasta'
...
nr="/scratch/user/devonjboland/A-Race/Transcriptome-Assembly/transdecoder_outdir/nr"
...
#blastp -query longest_orfs.pep -db ${nr} -max_target_seqs 1 -outfmt 6 -evalue 1e-5 -num_threads ${threads} -out blastp.outfmt6
