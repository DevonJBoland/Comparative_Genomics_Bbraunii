...
#SBATCH --job-name=Filter-Polish-Transcriptome-Lrace   #Set the job name to "JobExample2"
...
transcriptome='/scratch/user/devonjboland/L-Race/Transcriptome-Assembly/trinity_out_dir/Trinity-GG.fasta'
matrix='/scratch/user/devonjboland/L-Race/Transcriptome-Assembly/trinity_out_dir/rsem_outdir/RSEM.isoforms.results'
filtertranscriptome='/scratch/user/devonjboland/L-Race/Transcriptome-Assembly/trinity_out_dir/Lrace_High_Iso_Exp_Transcriptome_v2.fasta'
