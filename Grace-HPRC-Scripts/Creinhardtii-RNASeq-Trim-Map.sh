...
genome='Chlre5_6_AssemblyScaffolds_Repeatmasked.fasta'
pre='FastQC-pre'
post='FastQc-post'
mkdir ${pre}
mkdir ${post}
...
java -jar $EBROOTTRIMMOMATIC/trimmomatic-0.39.jar PE -threads $threads ${line}_1.fastq.gz ${line}_2.fastq.gz -baseout ${line}_trim ILLUMINACLIP:TruSeq.fa:2:30:10 SLIDINGWINDOW:4:5 LEADING:5 TRAILING:5 MINLEN:100
...
#do
hisat2 -p ${threads} -x ht2 -1 c_reinhardtii_RNAseq_Control_rep3_trim_1P,c_reinhardtii_RNAseq_Control_rep5_trim_1P,c_reinhardtii_RNAseq_Control_rep6_trim_1P -2 c_reinhardtii_RNAseq_Control_rep3_trim_2P,c_reinhardtii_RNAseq_Control_rep5_trim_2P,c_reinhardtii_RNAseq_Control_rep6_trim_2P -U c_reinhardtii_RNAseq_Control_rep3_trim_1U,c_reinhardtii_RNAseq_Control_rep5_trim_1U,c_reinhardtii_RNAseq_Control_rep6_trim_1U,c_reinhardtii_RNAseq_Control_rep3_trim_2U,c_reinhardtii_RNAseq_Control_rep5_trim_2U,c_reinhardtii_RNAseq_Control_rep6_trim_2U | samtools sort -o mapped-trim-reads.bam -T reads.tmp -
#done
