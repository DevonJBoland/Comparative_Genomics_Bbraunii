...
genome='ChlNC64A_1_nuclear_scaffolds.fasta'
pre='FastQC-pre'
post='FastQC-post'
mkdir ${pre}
mkdir ${post}
...
#do
hisat2 -p ${threads} -x ht2 -1 Replicate_1_Chlorella_variabilis_RNA-Seq_trim_1P,Replicate_2_Chlorella_variabilis_RNA-Seq_trim_1P,Replicate_3_Chlorella_variabilis_RNA-Seq_trim_1P -2 Replicate_1_Chlorella_variabilis_RNA-Seq_trim_2P,Replicate_2_Chlorella_variabilis_RNA-Seq_trim_2P,Replicate_3_Chlorella_variabilis_RNA-Seq_trim_2P -U Replicate_1_Chlorella_variabilis_RNA-Seq_trim_1U,Replicate_2_Chlorella_variabilis_RNA-Seq_trim_1U,Replicate_3_Chlorella_variabilis_RNA-Seq_trim_1U,Replicate_1_Chlorella_variabilis_RNA-Seq_trim_2U,Replicate_2_Chlorella_variabilis_RNA-Seq_trim_2U,Replicate_3_Chlorella_variabilis_RNA-Seq_trim_2U | samtools sort -o mapped-trim-reads.bam -T reads.tmp -
#done
