...
#SBATCH --job-name=Brace-Quickmerge-BUSCO            # job name
...
########## INPUTS ##########
genome_file='Arace-Nuclear-Genome-v1.fasta'
######## PARAMETERS ########
...
########## OUTPUTS #########
out_prefix="out_busco5_chlorophyta_odb10_chlamydomonas.Arace-Nuclear-Draft"
########## CONFIG ##########
