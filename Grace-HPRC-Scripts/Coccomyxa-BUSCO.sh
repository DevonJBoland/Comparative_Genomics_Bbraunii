...
#SBATCH --job-name=Coccomyxa-BUSCO            # job name
...
########## INPUTS ##########
genome_file='Coccomyxa_C169_v2_masked_genomic_scaffolds.fasta'
######## PARAMETERS ########
...
########## OUTPUTS #########
out_prefix="out_busco5_chlorophyta_odb10_chlamydomonas.Coccomyxa"
########## CONFIG ##########
